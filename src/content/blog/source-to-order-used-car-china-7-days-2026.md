---
title: "Source-to-Order in 7 Days: How We Match a Specific Used-Car SKU Brief from China's Deepest Pool"
description: "Most cross-border used-car operators sell what is on the lot. A real dealer brief — exact model, year, trim, mileage ceiling, target market — needs a deeper pool and a faster workflow. Here is the 7-day source-to-order process UCarsea runs against China's Pearl River Delta inventory: what it looks like, what it can and cannot promise, and three real briefs worked end-to-end."
pubDate: 2026-05-20
draft: false
category: Insights
tags:
  ...
  - vietnam
keywords:
  - source used car china to order
  - custom spec used car sourcing china
  - fast fob shenzhen used car
  - bulk used car sourcing china southeast asia dealer
  - guangdong used car sourcing southeast asia
  - pearl river delta used car export
  - china used car sku matching
---
...
1. **Pool depth** sufficient to make the brief reach hit a unit within days, not weeks.
2. **Inspection capacity** to pre-vet 2–4 candidates per brief without it eating margin on a thin job.
3. **Dispatch flexibility** so the matched unit actually ships on the dealer's timeline, by the right channel for the destination.
...
A Pearl River Delta operator working into a 2.76M-transaction provincial pool, with inspectors on payroll, sitting within a 50 km triangle of Shenzhen, Guangzhou, and Dongguan, can actually run the loop. See [Why source through China's Pearl River Delta — not anywhere else](https://blog.ucarsea.com/why-source-used-cars-pearl-river-delta-2026/) for the underlying pool depth case.
...
- Day 7: deposit in, paperwork starts. Sea transit ~14 days. See [Cambodia used car import duty 2026](https://blog.ucarsea.com/cambodia-used-car-import-duty-2026/) for the duty mechanics underneath.
...
- Day 5: FOB Shenzhen USD 15.2k. Landed Hanoi estimate USD 27k after the 3% EV-preferential SCT (see [Vietnam used car market decoded](https://blog.ucarsea.com/china-vs-japan-vietnam-used-car-decoded-2026/)).
...
- **Telegram**: [@ucarsea](https://t.me/ucarsea)
- **WhatsApp**: [direct chat](https://wa.me/message/VLIBSKFAOUMAE1)
- **Email**: sales@ucarsea.com
- **Form**: [send a brief](https://ucarsea.com/contact/)

For the underlying corridor and pool case, see [Why source through China's Pearl River Delta](https://blog.ucarsea.com/why-source-used-cars-pearl-river-delta-2026/) and the [China vs Japan ASEAN decision framework](https://blog.ucarsea.com/china-vs-japan-used-cars-asean-decision-framework-2026/).

[Browse current inventory](https://ucarsea.com/inventory/) · [Send a sourcing brief](https://ucarsea.com/contact/)
