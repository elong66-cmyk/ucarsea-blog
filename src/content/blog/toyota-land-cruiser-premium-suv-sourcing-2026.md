...
keywords:
  ...
  - land cruiser laos import
  - land cruiser china lhd export
  - used land cruiser 200 cambodia
  - land cruiser 300 import asean
  - toyota lc300 fob price china
  - land cruiser phnom penh price
  - premium suv import cambodia
---
...
2. **It is not a volume game**: you might sell 1-3 a month, not 10. The business model is *few units, fat margin, slow turn* — the inverse of the [Wuling Bingo](https://blog.ucarsea.com/wuling-bingo-entry-ev-sourcing-asean-2026/).
...
| Model | Years (used import) | Engine options (China-spec) | Note |
|---|---|---|---|
| **LC 200** | 2018-2021 | 4.0L V6 petrol / (limited diesel) | The proven workhorse, deepest parts depth |
| **LC 300** | 2022-2024 | 3.5L V6 twin-turbo petrol / 3.3L V6 diesel | Newer platform, higher landed cost, growing buyer acceptance |
...
Laos's excise scale is marginally softer than Cambodia's at the top displacement band, and the railway saves on oversize freight vs sea. For Land Cruisers specifically, the [Laos corridor](https://blog.ucarsea.com/china-vs-japan-laos-importers-look-north/) often nets a few thousand USD better than the Cambodia sea route.

## Resale benchmarks (Q1-Q2 2026)

| Market | 2019 LC 200 | 2021 LC 200 | 2023 LC 300 |
|---|---|---|---|
...
This is where the Land Cruiser's case is unassailable: **parts and service depth are global and total**. Every market we serve has Land Cruiser mechanics, parts, and a deep used-parts ecosystem. NGOs spec it precisely *because* it can be kept running anywhere. Year-5 (and year-15) service cost predictability is the best of any SKU we handle — see [Parts & Service](https://blog.ucarsea.com/parts-service-japan-vs-china-after-5-years-sea-2026/).

## When the Land Cruiser is the wrong answer

- **Capital-constrained dealer**: do not lock $120K in one unit if it strains your float — build the [Camry](https://blog.ucarsea.com/toyota-camry-china-lhd-sourcing-asean-2026/) volume business first.
- **Urban-only buyer wanting prestige not capability**: a Lexus LX or a loaded [BYD Han](https://blog.ucarsea.com/byd-han-asean-executive-sedan-2026.md) may fit better.
...
[Inventory](https://ucarsea.com/inventory/) · [Inquiry](https://ucarsea.com/contact/) · [Cambodia duty](https://blog.ucarsea.com/cambodia-used-car-import-duty-2026/) · [Decision hub](https://blog.ucarsea.com/china-vs-japan-used-cars-asean-decision-framework-2026/)
