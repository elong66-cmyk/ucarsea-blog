---
title: "China vs Japan: Why Laos Importers Increasingly Look North"
description: "Laos has spent decades importing used cars from Japan. That math is now flipping. The China-Laos railway delivers 36 hours from Kunming to Vientiane vs 25 days of sea-then-overland from Japan. Laos is LHD — and so is China. Here's the structural case for sourcing from the north."
pubDate: 2026-05-14
category: Laos
tags:
  - laos
  ...
  - "2026"
keywords:
  - china vs japan used car laos
  - laos importer china source
  - china laos railway used car
  - vientiane car import china
  - kunming vientiane car shipping
---
...
1. The **train from Kunming to Vientiane** quietly turned a 25-day Japan-route shipment into a 36-hour overland delivery.
2. Laos is a **left-hand-drive country** — which means Chinese-spec cars are a direct match, while Japan-spec cars need conversion or careful auction filtering.
3. Used-car **inventory volume** in China is now an order of magnitude bigger than what Japan can export to Laos, and growing faster.
...
We covered the operational walkthrough in detail in [China to Laos Car Shipping via Kunming](https://blog.ucarsea.com/china-to-laos-car-shipping-kunming/). The headline is simpler than the timeline: **the China-Laos railway turned cross-border auto into a 36-hour move**. That's not a marginal improvement. That's a structural rerouting of how cars get to Vientiane.
...
For a deeper RHD/LHD analysis across ASEAN see our [Cambodia sourcing article](https://blog.ucarsea.com/china-vs-japan-used-cars-cambodia-2026/), where the same constraint shows up even more aggressively (Cambodia outright banned RHD imports in 2022).
...
|---|---|
| **Used EVs** | Japan has effectively zero used EV export supply (BEV penetration <2%). China is the only at-scale source. See [the EV question article](https://blog.ucarsea.com/china-vs-japan-ev-supply-asean-2026/) for the full supply math. |
...
1. **Pre-shipment inspection** (third-party in China, certificate issued)
2. **Export customs declaration** (Kunming side)
3. **Bilateral handover at Mohan-Boten** (typically same-day)
4. **Lao import declaration** (Vientiane South Terminal)
5. **Excise + VAT settlement** (Lao tax authority)
6. **Vehicle registration application** (Department of Transport)

The duty stack on a used car imported from China to Laos varies by engine displacement, emission compliance, and EV status. Under the 2025 Laos used-car import policy framework — see our [full duty breakdown](https://blog.ucarsea.com/laos-used-car-import-policy-2025/) — EV-classified imports get meaningful preferential treatment.
...
1. **Established Japan-side supplier relationships.** A dealer with a 15-year relationship to a USS auction broker has zero switching incentive on the existing business. The switch only happens for new SKUs or new volume.
2. **Customer education burden on Chinese brands.** A Toyota walks itself out the door. A Geely Boyue requires the salesperson to do brand introduction work. That's a real cost the spreadsheet doesn't capture.
3. **After-sales spare parts uncertainty.** A 2023 Chery sourced today and needing a control arm in 2027 — the dealer has to believe the parts chain will be there. Two years ago that belief was hard to justify. Today it's getting easier. In another two years it will be a non-issue.
...
[Browse current inventory →](https://ucarsea.com/?post_type=vehicle)

---

## Related reading

- [China to Laos Car Shipping via Kunming](https://blog.ucarsea.com/china-to-laos-car-shipping-kunming/) — the 36-hour railway corridor, operational walkthrough
- [Laos Used Car Import Policy 2025](https://blog.ucarsea.com/laos-used-car-import-policy-2025/) — the duty stack and the new policy window
- [Total Cost: Importing a 2019 Toyota Camry from China to Laos](https://blog.ucarsea.com/total-cost-camry-china-to-laos/) — exact USD line items for a real Vientiane shipment
- [China vs Japan: The EV Question — Why Japan Has No Used EV Supply](https://blog.ucarsea.com/china-vs-japan-ev-supply-asean-2026/) — series A #2, supply-side EV math
- [China vs Japan: Used Car Sourcing for Cambodia in 2026](https://blog.ucarsea.com/china-vs-japan-used-cars-cambodia-2026/) — series A #1, the RHD/LHD entry point
